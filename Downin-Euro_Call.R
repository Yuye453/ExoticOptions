...
# Inputs
S = 200     # Stock price at time zero  
E = 60     # Strike Price
T = 1       # Time Horizon in years
r = 0.05    # Risk free rate
sigma = 0.3 # Volatility
M = 50      # Number of time intervals
B = 180    # Barrier price B<S
p = 1/2     # Probability of an increment in the stock price

    # Function
    DownIn_Euro_Call_option = function(S, E, T, r, sigma, M, B, p) {
...
# Example
DownIn_Euro_Call_option(S = 200, E = 60, T = 1, r = 0.05, sigma = 0.3, M = 50, B = 180, p = 1/2)
